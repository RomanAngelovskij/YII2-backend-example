// Chart setup
function dailyStat(dataset, element, height, lineColor) {
    ...
    var tooltip = d3.tip()
        ...
        .html(function (d) {
            return "<ul class='list-unstyled mb-5'>" +
                ...
                "<li>" + "Кол-во: &nbsp;" + "<span class='text-semibold pull-right'>" + d.cnt + "</span>" + "</li>" +
                "</ul>";
        });
    ...
    guide
        ...
        .style('stroke', 'rgba(41,182,246,0.3)')
