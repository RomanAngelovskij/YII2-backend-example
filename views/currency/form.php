...
$this->title = $model->isNewRecord ? 'Добавление валюты' : 'Редактирование валюты: ' . $model->name;
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <a href="/currency"><i class="<?= !isset($this->params['titleIcon']) ? 'icon-arrow-left52' : $this->params['titleIcon'] ?> position-left"></i></a>
        ...
        <div class="content-wrapper">
            <div class="panel panel-flat">
                <div class="panel-body">
                    ...
                    <div class="col-md-16">
                        <?= $form->field($model, 'countries')->checkboxList(
