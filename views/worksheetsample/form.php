...
$this->title = $model->isNewRecord ? 'Добавление типа заявки' : 'Редактирование типа заявки: ' . $model->name;
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <a href="/worksheetsample"><i class="<?= !isset($this->params['titleIcon']) ? 'icon-arrow-left52' : $this->params['titleIcon'] ?> position-left"></i></a>
