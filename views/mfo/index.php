            ...
            <?= \yii\grid\GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'content' => function($data){
                            $linkName = strlen($data->link) > 50 ? substr($data->link, 0, 50) . '...' : $data->link;
                            return $data->legal_name . '<br>' . '<a href="' . $data->link . '" target="_blank">' . $linkName . '</a>';
                        }
                    ],
                    [
