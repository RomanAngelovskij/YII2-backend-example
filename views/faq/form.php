...
$this->title = $model->isNewRecord ? 'Добавление FAQ' : 'Редактирование FAQ';
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    <a href="/faq"><i class="<?= !isset($this->params['titleIcon']) ? 'icon-arrow-left52' : $this->params['titleIcon'] ?> position-left"></i></a>
