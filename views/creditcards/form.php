...
$this->title = $model->isNewRecord ? 'Добавление кредитной карты' : 'Редактирование кредитной карты: ' . $model->name;
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <a href="/creditcards"><i class="<?= !isset($this->params['titleIcon']) ? 'icon-arrow-left52' : $this->params['titleIcon'] ?> position-left"></i></a>
