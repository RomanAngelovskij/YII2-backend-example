...
$this->title = $model->isNewRecord ? 'Добавление поля адреса' : 'Редактирование поля адреса для типа заявки "' . $model->worksheetsample->name . '"';
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <a href="/addresses"><i class="<?= !isset($this->params['titleIcon']) ? 'icon-arrow-left52' : $this->params['titleIcon'] ?> position-left"></i></a>
        ...
        <div class="heading-elements">
            ...
            <div class="heading-btn-group">
                <a href="/addresses/add" class="btn btn-link btn-float has-text"><i
                            ...
                            <div class="panel-body">
                                <div style="display: inline-block; width: 97%; float: left; margin-right: 5px;">
                                    <?= Html::dropDownList('copy-from', null,
                                        \app\models\WorksheetsamplesAddresses::getListForDropdown(),
                                        ['class' => 'form-control']) ?>
                                </div>
        ...
        $.ajax({
            ...
            success: function(response){
                $.each(response, function(indx, value){
                    var field = $("[name=\'WorksheetsamplesAddresses\[" + indx + "\]\']");
